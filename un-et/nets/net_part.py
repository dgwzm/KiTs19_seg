...
from .networks_init import init_weights
#unetConv2, UnetUp2_CT, UnetGridGatingSignal2, UnetDsv2
...
class unetUp(nn.Module):
    def __init__(self, in_size, out_size, is_deconv):
        ...
        #print("int",in_size,"out",out_size)
        self.conv = unetConv2(in_size, out_size, False)
        if is_deconv: #256,128
    ...
    def forward(self, inputs1, inputs2):
        ...
        #print("inputs1",inputs1.shape,"outputs1",outputs1.shape,"outputs2",outputs2.shape,padding)

        return self.conv(torch.cat([outputs1, outputs2], 1))  #256+128->128
...
class UnetUp2_CT(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm=True):
        ...
        self.conv = unetConv2(in_size + out_size, out_size, is_batchnorm, ks=(3,3), padding=(1,1))
